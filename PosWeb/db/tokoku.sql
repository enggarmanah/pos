...
-- Dumping data for table tokoku.customer: ~4 rows (approximately)
DELETE FROM `customer`;
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
INSERT INTO `customer` (`id`, `merchant_id`, `remote_id`, `name`, `telephone`, `email`, `email_status`, `address`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
...
-- Dumping structure for table tokoku.device
...
-- Dumping data for table tokoku.device: ~4 rows (approximately)
DELETE FROM `device`;
...
INSERT INTO `device` (`id`, `merchant_id`, `uuid`, `last_sync_date`) VALUES
	...
	(52, 1, '18fc9c84-c82f-4434-b3de-3ffcf87e1989', '2015-02-17 17:14:40');
/*!40000 ALTER TABLE `device` ENABLE KEYS */;


-- Dumping structure for table tokoku.discount
...
-- Dumping data for table tokoku.discount: ~4 rows (approximately)
DELETE FROM `discount`;
/*!40000 ALTER TABLE `discount` DISABLE KEYS */;
INSERT INTO `discount` (`id`, `merchant_id`, `remote_id`, `name`, `percentage`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
...
-- Dumping structure for table tokoku.employee
...
-- Dumping data for table tokoku.employee: ~4 rows (approximately)
DELETE FROM `employee`;
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT INTO `employee` (`id`, `merchant_id`, `remote_id`, `name`, `telephone`, `address`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
...
-- Dumping structure for table tokoku.merchant
...
-- Dumping data for table tokoku.merchant: ~2 rows (approximately)
DELETE FROM `merchant`;
/*!40000 ALTER TABLE `merchant` DISABLE KEYS */;
INSERT INTO `merchant` (`id`, `remote_id`, `name`, `type`, `address`, `telephone`, `contact_name`, `contact_telephone`, `login_id`, `password`, `period_start`, `period_end`, `tax_percentage`, `service_charge_percentage`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
	...
	(15, 2, 'Warung Babe Gimin', 'R', 'Jl Hasanuddin 31 Jakarta Pusat', NULL, 'Suparman', '021 756123', 'babegimin', '12345678', '2015-02-06 16:00:00', '2016-02-06 16:00:00', 0, 0, 'A', 'retno', '2015-02-07 10:41:55', 'retno', '2015-02-07 18:45:46');
/*!40000 ALTER TABLE `merchant` ENABLE KEYS */;


-- Dumping structure for table tokoku.product
...
-- Dumping data for table tokoku.product: ~18 rows (approximately)
DELETE FROM `product`;
/*!40000 ALTER TABLE `product` DISABLE KEYS */;
INSERT INTO `product` (`id`, `merchant_id`, `remote_id`, `product_group_id`, `name`, `type`, `price`, `cost_price`, `pic_required`, `commision`, `promo_price`, `promo_start`, `promo_end`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
...
-- Dumping structure for table tokoku.product_group
...
-- Dumping data for table tokoku.product_group: ~5 rows (approximately)
DELETE FROM `product_group`;
/*!40000 ALTER TABLE `product_group` DISABLE KEYS */;
INSERT INTO `product_group` (`id`, `merchant_id`, `remote_id`, `name`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
...
-- Dumping structure for table tokoku.transactions
...
-- Dumping data for table tokoku.transactions: ~18 rows (approximately)
DELETE FROM `transactions`;
/*!40000 ALTER TABLE `transactions` DISABLE KEYS */;
INSERT INTO `transactions` (`id`, `merchant_id`, `remote_id`, `transaction_no`, `transaction_date`, `bill_amount`, `discount_name`, `discount_percentage`, `discount_amount`, `tax_percentage`, `tax_amount`, `service_charge_percentage`, `service_charge_amount`, `total_amount`, `payment_amount`, `return_amount`, `payment_type`, `cashier_id`, `cashier_name`, `customer_id`, `customer_name`, `status`) VALUES
...
-- Dumping structure for table tokoku.transaction_item
...
-- Dumping data for table tokoku.transaction_item: ~42 rows (approximately)
DELETE FROM `transaction_item`;
/*!40000 ALTER TABLE `transaction_item` DISABLE KEYS */;
INSERT INTO `transaction_item` (`id`, `merchant_id`, `remote_id`, `transaction_id`, `product_id`, `product_name`, `product_type`, `price`, `cost_price`, `discount`, `quantity`, `employee_id`) VALUES
...
-- Dumping structure for table tokoku.user
...
-- Dumping data for table tokoku.user: ~3 rows (approximately)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `merchant_id`, `remote_id`, `name`, `user_id`, `password`, `role`, `status`, `create_by`, `create_date`, `update_by`, `update_date`) VALUES
