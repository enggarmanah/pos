...
public class Bills extends Base {
    ...
    public void setBean(Bills bean) {

		super.setBean(bean);
		
		this.bill_reference_no = bean.getBill_reference_no();
		this.bill_type = bean.getBill_type();
		this.bill_date = bean.getBill_date();
		this.bill_due_date = bean.getBill_due_date();
		this.bill_amount = bean.getBill_amount();
		this.payment_date = bean.getPayment_date();
