...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig billsItemDaoConfig;
    ...
    private final BillsItemDao billsItemDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        billsItemDaoConfig = daoConfigMap.get(BillsItemDao.class).clone();
        billsItemDaoConfig.initIdentityScope(type);
        ...
        billsItemDao = new BillsItemDao(billsItemDaoConfig, this);
        ...
        registerDao(BillsItem.class, billsItemDao);
    ...
    public void clear() {
        ...
        billsItemDaoConfig.getIdentityScope().clear();
    ...
    public BillsItemDao getBillsItemDao() {
        return billsItemDao;
    }
