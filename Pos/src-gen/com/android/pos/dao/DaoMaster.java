...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        CashflowDao.createTable(db, ifNotExists);
        InventoryDao.createTable(db, ifNotExists);
        MerchantAccessDao.createTable(db, ifNotExists);
        UserAccessDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        CashflowDao.dropTable(db, ifExists);
        InventoryDao.dropTable(db, ifExists);
        MerchantAccessDao.dropTable(db, ifExists);
        UserAccessDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(MerchantAccessDao.class);
        registerDaoClass(UserAccessDao.class);
    }
