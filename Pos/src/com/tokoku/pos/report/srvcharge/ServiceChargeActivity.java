...
public class ServiceChargeActivity extends BaseActivity 
	implements ServiceChargeActionListener {
	
	protected ServiceChargeListFragment mTransactionListFragment;
	protected ServiceChargeDetailFragment mTransactionDetailFragment;
	...
	public void onStart() {
		...
		setTitle(getString(R.string.menu_report_service_charge));
		setSelectedMenu(getString(R.string.menu_report_service_charge));
	}
	...
	private void initFragments() {
		...
		mTransactionListFragment = (ServiceChargeListFragment) getFragmentManager().findFragmentByTag(mTransactionListFragmentTag);
		
		if (mTransactionListFragment == null) {
			mTransactionListFragment = new ServiceChargeListFragment();

		} else {
			removeFragment(mTransactionListFragment);
		}
		
		mTransactionDetailFragment = (ServiceChargeDetailFragment) getFragmentManager().findFragmentByTag(mTransactionDetailFragmentTag);
		
		if (mTransactionDetailFragment == null) {
			mTransactionDetailFragment = new ServiceChargeDetailFragment();
