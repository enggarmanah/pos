...
public class ServiceChargeDayArrayAdapter extends ArrayAdapter<TransactionDayBean> {
	...
	public ServiceChargeDayArrayAdapter(Context context, List<TransactionDayBean> transactions, ItemActionListener listener) {
