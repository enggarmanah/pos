...
public class ServiceChargeYearArrayAdapter extends ArrayAdapter<TransactionYearBean> {
	...
	public ServiceChargeYearArrayAdapter(Context context, List<TransactionYearBean> transactionYears, ItemActionListener listener) {
