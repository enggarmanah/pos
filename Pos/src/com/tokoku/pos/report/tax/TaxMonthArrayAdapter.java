...
public class TaxMonthArrayAdapter extends ArrayAdapter<TransactionMonthBean> {
	...
	public TaxMonthArrayAdapter(Context context, List<TransactionMonthBean> transactionMonths, ItemActionListener listener) {
