...
public class TaxYearArrayAdapter extends ArrayAdapter<TransactionYearBean> {
	...
	public TaxYearArrayAdapter(Context context, List<TransactionYearBean> transactionYears, ItemActionListener listener) {
