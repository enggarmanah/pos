...
public class TaxDayArrayAdapter extends ArrayAdapter<TransactionDayBean> {
	...
	public TaxDayArrayAdapter(Context context, List<TransactionDayBean> transactions, ItemActionListener listener) {
