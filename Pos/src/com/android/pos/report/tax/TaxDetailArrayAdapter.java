...
public class TaxDetailArrayAdapter extends ArrayAdapter<TransactionItem> {
	...
	public TaxDetailArrayAdapter(Context context, List<TransactionItem> transactionItems, ItemActionListener listener) {
