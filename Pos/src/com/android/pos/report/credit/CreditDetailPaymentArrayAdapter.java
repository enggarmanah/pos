...
public class CreditDetailPaymentArrayAdapter extends ArrayAdapter<Cashflow> {
	...
	public CreditDetailPaymentArrayAdapter(Context context, List<Cashflow> cashflows) {
