...
public class ServiceChargeArrayAdapter extends ArrayAdapter<Transactions> {
	...
	public ServiceChargeArrayAdapter(Context context, List<Transactions> transactions, ItemActionListener listener) {
