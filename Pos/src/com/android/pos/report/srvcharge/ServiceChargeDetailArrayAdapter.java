...
public class ServiceChargeDetailArrayAdapter extends ArrayAdapter<TransactionItem> {
	...
	public ServiceChargeDetailArrayAdapter(Context context, List<TransactionItem> transactionItems, ItemActionListener listener) {
