...
public class CashFlowBillDetailArrayAdapter extends ArrayAdapter<Inventory> {
	...
	public CashFlowBillDetailArrayAdapter(Context context, List<Inventory> productStatistics) {
