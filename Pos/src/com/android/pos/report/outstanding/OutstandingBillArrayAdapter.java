...
public class OutstandingBillArrayAdapter extends ArrayAdapter<Bills> {
	...
	public OutstandingBillArrayAdapter(Context context, List<Bills> bills, ItemActionListener listener) {
